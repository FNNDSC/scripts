...
TARGET_CHECK[19]="tunnel.bash --reverse --from rudolph@${DOOR}:1148 --to chris.nmr.mgh.harvard.edu:22 --isRunning"
TARGETACTION[19]="tunnel.bash --reverse --from rudolph@${DOOR}:1148 --to chris.nmr.mgh.harvard.edu:22"
TARGET_CHECK[20]="tunnel.bash --reverse --from rudolph@${DOOR}:1188 --to chris.nmr.mgh.harvard.edu:80 --isRunning"
TARGETACTION[20]="tunnel.bash --reverse --from rudolph@${DOOR}:1188 --to chris.nmr.mgh.harvard.edu:80"
TARGET_CHECK[21]="tunnel.bash --reverse --from rudolph@${DOOR}:1143 --to chris.nmr.mgh.harvard.edu:443 --isRunning"
TARGETACTION[21]="tunnel.bash --reverse --from rudolph@${DOOR}:1143 --to chris.nmr.mgh.harvard.edu:443"
