...
TARGETCHECK[0]="psa 5555  | grep $(whoami) | grep -v grep |  wc -l"
TARGETACTION[0]="(exec /chb/users/ginsburg/workspace2/trunk/scripts/sshTunnel_restart.sh -B -H osx2147.tch.harvard.edu -h dreev.tch.harvard.edu -u ch141111 -R 5555 -L 22)"
TARGETCHECK[1]="psa 5556  | grep $(whoami) | grep -v grep |  wc -l"
TARGETACTION[1]="(exec /chb/users/ginsburg/workspace2/trunk/scripts/sshTunnel_restart.sh -B -H natal.tch.harvard.edu -h dreev.tch.harvard.edu -u ch141111 -R 5556 -L 22)"
TARGETCHECK[2]="psa 10409  | grep $(whoami) | grep -v grep |  wc -l"
TARGETACTION[2]="(exec /chb/users/ginsburg/workspace2/trunk/scripts/sshTunnel_restart.sh -F -H localhost -h gate.nmr.mgh.harvard.edu -u ginsburg -R 10409 -L 10409 -g)"
TARGETCHECK[3]="psa 5559  | grep $(whoami) | grep -v grep |  wc -l"
TARGETACTION[3]="(exec /chb/users/ginsburg/workspace2/trunk/scripts/sshTunnel_restart.sh -F -H localhost -h gate.nmr.mgh.harvard.edu -u ginsburg -R 5559 -L 5559 -g)"
