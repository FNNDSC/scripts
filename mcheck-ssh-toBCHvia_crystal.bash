...
targetList=30
 ...
 TARGET_CHECK[6]="tunnel.bash --forward --sshArgs '-p 22022' --from 8000 --via rudolphpienaar@${DOOR} --to localhost:8000 --isRunning"
 TARGETACTION[6]="tunnel.bash --forward --sshArgs '-p 22022' --from 8000 --via rudolphpienaar@${DOOR} --to localhost:8000"
...
TARGET_CHECK[12]="tunnel.bash --forward --from 6812 --via rudolphpienaar@${DOOR} --to localhost:22 --sshArgs '-p 22022' --isRunning"
TARGETACTION[12]="tunnel.bash --forward --from 6812 --via rudolphpienaar@${DOOR} --to localhost:22 --sshArgs '-p 22022'"
