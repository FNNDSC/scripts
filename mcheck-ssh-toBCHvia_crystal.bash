...
targetList=32
 ...
 TARGET_CHECK[6]="tunnel.bash --forward --sshArgs '-p 22022' --from 8011 --via rudolphpienaar@${DOOR} --to localhost:8000 --isRunning"
 TARGETACTION[6]="tunnel.bash --forward --sshArgs '-p 22022' --from 8011 --via rudolphpienaar@${DOOR} --to localhost:8000"
