...
#
 ...
 TARGET_CHECK[3]="tunnel.bash --forward	--from 9900  --via ch137123@${DREEV} --to localhost:9900 --isRunning"
 TARGETACTION[3]="tunnel.bash --forward	--from 9900  --via ch137123@${DREEV} --to localhost:9900"
 ...
 TARGET_CHECK[8]="tunnel.bash --forward	--from 4212  --via ch137123@${DREEV} --to localhost:4212 --isRunning"
 TARGETACTION[8]="tunnel.bash --forward	--from 4212  --via ch137123@${DREEV} --to localhost:4212"
 TARGET_CHECK[9]="tunnel.bash --forward	--from 4214  --via ch137123@${DREEV} --to localhost:4214 --isRunning"
 TARGETACTION[9]="tunnel.bash --forward	--from 4214  --via ch137123@${DREEV} --to localhost:4214"
TARGET_CHECK[10]="tunnel.bash --forward	--from 4215  --via ch137123@${DREEV} --to localhost:4215 --isRunning"
TARGETACTION[10]="tunnel.bash --forward	--from 4215  --via ch137123@${DREEV} --to localhost:4215"
TARGET_CHECK[11]="tunnel.bash --forward	--from 4216  --via ch137123@${DREEV} --to localhost:4216 --isRunning"
TARGETACTION[11]="tunnel.bash --forward	--from 4216  --via ch137123@${DREEV} --to localhost:4216"
TARGET_CHECK[12]="tunnel.bash --forward	--from 8000  --via ch137123@${DREEV} --to localhost:8000 --isRunning"
