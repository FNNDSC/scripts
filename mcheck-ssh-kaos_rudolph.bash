...
TARGETCHECK[0]="psa 7777  | grep $(whoami) | grep -v grep | grep ssh | wc -l"
TARGETACTION[0]="(exec ~/arch/scripts/sshTunnel_restart.sh  -g -F -L 7777 -H localhost -R 7777 -u ch137123 -h dreev.tch.harvard.edu)"
TARGETCHECK[1]="psa 10402 | grep dreev  | grep $(whoami) | grep -v grep | grep ssh | wc -l"
TARGETACTION[1]="(exec ~/arch/scripts/sshTunnel_restart.sh -g -F -L 10402 -H localhost -R 10402 -u ch137123 -h dreev.tch.harvard.edu)"
TARGETCHECK[2]="psa 8888| grep $(whoami) | grep -v grep | grep ssh |  wc -l"
TARGETACTION[2]="(exec ~/arch/scripts/sshTunnel_restart.sh -g -F -H localhost -h dreev.tch.harvard.edu -u ch137123 -R 8888 -L 8888)"
TARGETCHECK[3]="psa 4204 | grep $(whoami) | grep -v grep | grep ssh | wc -l"
TARGETACTION[3]="(exec ~/arch/scripts/sshTunnel_restart.sh -g -F -L 4204 -H localhost -R 4204 -u ch137123 -h dreev.tch.harvard.edu)"
TARGETCHECK[4]="psa 4212 | grep $(whoami) | grep -v grep | grep ssh | wc -l"
TARGETACTION[4]="(exec ~/arch/scripts/sshTunnel_restart.sh -g -F -L 4212 -H localhost -R 4212 -u ch137123 -h dreev.tch.harvard.edu)"
TARGETCHECK[5]="psa 4214 | grep $(whoami) | grep -v grep | grep ssh | wc -l"
TARGETACTION[5]="(exec ~/arch/scripts/sshTunnel_restart.sh -g -F -L 4214 -H localhost -R 4214 -u ch137123 -h dreev.tch.harvard.edu)"
TARGETCHECK[6]="psa 10403 | grep gate    | grep $(whoami) | grep -v grep | grep ssh | wc -l"
TARGETACTION[6]="(exec ~/arch/scripts/sshTunnel_restart.sh -g -R 10403 -H kaos -h gate -u rudolph -L 10402 )"

TARGETCHECK[7]="psa 5556  | grep $(whoami) | grep -v grep | grep ssh | wc -l"
TARGETACTION[7]="(exec ~/arch/scripts/sshTunnel_restart.sh -g -F -H localhost -h dreev.tch.harvard.edu -u ch137123 -R 5556 -L 5556)"
TARGETCHECK[8]="psa 5559  | grep $(whoami) | grep -v grep |  grep ssh | wc -l"
TARGETACTION[8]="(exec ~/arch/scripts/sshTunnel_restart.sh -g -B -H kaos -h gate -u rudolph -R 5559 -L 80)"

TARGETCHECK[9]="psa 8000 | grep $(whoami) | grep -v grep | grep ssh | wc -l"
TARGETACTION[9]="(exec ~/arch/scripts/sshTunnel_restart.sh -g -F -L 8000 -H localhost -R 8000 -u ch137123 -h dreev.tch.harvard.edu)"


#TARGETCHECK[9]="psa 10409  | grep $(whoami) | grep -v grep |  grep ssh | wc -l"
#TARGETACTION[9]="(exec ~/arch/scripts/sshTunnel_restart.sh -g -B -H kaos -h gate -u rudolph -R 10409 -L 10401 -g)"
