...
TARGET_CHECK[21]="tunnel.bash --reverse --from ch137123@${DREEV}:1143 --to chris.nmr.mgh.harvard.edu:443 --isRunning"
TARGETACTION[21]="tunnel.bash --reverse --from ch137123@${DREEV}:1143 --to chris.nmr.mgh.harvard.edu:443"
TARGET_CHECK[22]="tunnel.bash --forward --from 2137 --via ch137123@${DREEV} --to localhost:2137 --isRunning"
TARGETACTION[22]="tunnel.bash --forward --from 2137 --via ch137123@${DREEV} --to localhost:2137"
TARGET_CHECK[23]="tunnel.bash --forward --from 3228 --via ch137123@${DREEV} --to localhost:3228 --isRunning"
TARGETACTION[23]="tunnel.bash --forward --from 3228 --via ch137123@${DREEV} --to localhost:3228"
TARGET_CHECK[24]="tunnel.bash --forward --from 8443 --via ch137123@${DREEV} --to localhost:8443 --isRunning"
TARGETACTION[24]="tunnel.bash --forward --from 8443 --via ch137123@${DREEV} --to localhost:8443"
TARGET_CHECK[25]="tunnel.bash --forward --from 3142 --via ch137123@${DREEV} --to localhost:3142 --isRunning"
TARGETACTION[25]="tunnel.bash --forward --from 3142 --via ch137123@${DREEV} --to localhost:3142"
TARGET_CHECK[26]="tunnel.bash --reverse --from ch137123@${DREEV}:7772 --to heisenberg:22 --isRunning"
TARGETACTION[26]="tunnel.bash --reverse --from ch137123@${DREEV}:7772 --to heisenberg:22"
TARGET_CHECK[27]="tunnel.bash --forward --from 2214 --via ch137123@${DREEV} --to localhost:2214 --isRunning"
TARGETACTION[27]="tunnel.bash --forward --from 2214 --via ch137123@${DREEV} --to localhost:2214"
