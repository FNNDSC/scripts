...
targetList=14
 ...
 TARGET_CHECK[8]="tunnel.bash --forward	--from 9900 --via ch137123@${DREEV} --to localhost:9900 --isRunning"
 TARGETACTION[8]="tunnel.bash --forward	--from 9900 --via ch137123@${DREEV} --to localhost:9900"
 TARGET_CHECK[9]="tunnel.bash --forward	--from 9000 --via rudolph@${H1} --to localhost:80 --sshArgs '-p 7778' --isRunning"
 TARGETACTION[9]="tunnel.bash --forward	--from 9000 --via rudolph@${H1} --to localhost:80 --sshArgs '-p 7778'"
TARGET_CHECK[10]="tunnel.bash --forward	--from 6812 --via rudolph@${H1} --to localhost:22 --sshArgs '-p 7778' --isRunning"
TARGETACTION[10]="tunnel.bash --forward	--from 6812 --via rudolph@${H1} --to localhost:22 --sshArgs '-p 7778'"
TARGET_CHECK[11]="tunnel.bash --reverse --from ch137123@${DREEV}:7776 --to localhost:22 --isRunning"
TARGETACTION[11]="tunnel.bash --reverse --from ch137123@${DREEV}:7776 --to localhost:22"
TARGET_CHECK[12]="tunnel.bash --reverse --from ch137123@${DREEV}:7775 --to heisenberg:22 --isRunning"
TARGETACTION[12]="tunnel.bash --reverse --from ch137123@${DREEV}:7775 --to heisenberg:22"
TARGET_CHECK[13]="tunnel.bash --forward --from 10402 --via ch137123@${DREEV} --to localhost:10402 --isRunning"
TARGETACTION[13]="tunnel.bash --forward --from 10402 --via ch137123@${DREEV} --to localhost:10402"
