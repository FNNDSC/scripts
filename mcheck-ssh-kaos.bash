...
targetList=12
 ...
 TARGET_CHECK[1]="tunnel.bash --forward --from 4214 --via ch137123@${DREEV} --to localhost:4214 --isRunning"
 TARGETACTION[1]="tunnel.bash --forward --from 4212 --via ch137123@${DREEV} --to localhost:4212"
 TARGET_CHECK[2]="tunnel.bash --forward --from 4215 --via ch137123@${DREEV} --to localhost:4215 --isRunning"
 TARGETACTION[2]="tunnel.bash --forward --from 4215 --via ch137123@${DREEV} --to localhost:4215"
 TARGET_CHECK[3]="tunnel.bash --forward --from 4216 --via ch137123@${DREEV} --to localhost:4216 --isRunning"
 TARGETACTION[3]="tunnel.bash --forward --from 4216 --via ch137123@${DREEV} --to localhost:4216"
 TARGET_CHECK[4]="tunnel.bash --forward --from 7777 --via ch137123@${DREEV} --to localhost:7777 --isRunning"
 TARGETACTION[4]="tunnel.bash --forward --from 7777 --via ch137123@${DREEV} --to localhost:7777"
 TARGET_CHECK[5]="tunnel.bash --forward --from 8000 --via ch137123@${DREEV} --to localhost:8000 --isRunning"
 TARGETACTION[5]="tunnel.bash --forward --from 8000 --via ch137123@${DREEV} --to localhost:8000"
 TARGET_CHECK[6]="tunnel.bash --forward --from 3204 --via ch137123@${DREEV} --to localhost:3204 --isRunning"
 TARGETACTION[6]="tunnel.bash --forward --from 3204 --via ch137123@${DREEV} --to localhost:3204"
 TARGET_CHECK[7]="tunnel.bash --forward	--from 9900 --via ch137123@${DREEV} --to localhost:9900 --isRunning"
 TARGETACTION[7]="tunnel.bash --forward	--from 9900 --via ch137123@${DREEV} --to localhost:9900"
 TARGET_CHECK[8]="tunnel.bash --forward	--from 9000 --via rudolph@${H1} --to localhost:80 --sshArgs '-p 7778' --isRunning"
 TARGETACTION[8]="tunnel.bash --forward	--from 9000 --via rudolph@${H1} --to localhost:80 --sshArgs '-p 7778'"
 TARGET_CHECK[9]="tunnel.bash --forward	--from 6812 --via rudolph@${H1} --to localhost:22 --sshArgs '-p 7778' --isRunning"
 TARGETACTION[9]="tunnel.bash --forward	--from 6812 --via rudolph@${H1} --to localhost:22 --sshArgs '-p 7778'"
TARGET_CHECK[10]="tunnel.bash --reverse --from ch137123@${DREEV}:7776 --to localhost:22 --isRunning"
TARGETACTION[10]="tunnel.bash --reverse --from ch137123@${DREEV}:7776 --to localhost:22"
TARGET_CHECK[11]="tunnel.bash --reverse --from ch137123@${DREEV}:7775 --to heisenberg:22 --isRunning"
TARGETACTION[11]="tunnel.bash --reverse --from ch137123@${DREEV}:7775 --to heisenberg:22"
