...
TARGET_CHECK[1]="tunnel.bash --reverse --sshArgs '-p 22022'	--from rudolphpienaar@${GATE}:1476 	--to ${OSX1476}:5900 --isRunning"
TARGETACTION[1]="tunnel.bash --reverse --sshArgs '-p 22022'	--from rudolphpienaar@${GATE}:1476 	--to ${OSX1476}:5900"
...
TARGET_CHECK[5]="tunnel.bash --reverse --sshArgs '-p 22022' 	--from rudolphpienaar@${GATE}:8000 	--to ${DURBAN}:80 --isRunning"
TARGETACTION[5]="tunnel.bash --reverse --sshArgs '-p 22022' 	--from rudolphpienaar@${GATE}:8000 	--to ${DURBAN}:80"
...
TARGET_CHECK[9]="tunnel.bash --reverse --sshArgs '-p 22022'	--from rudolphpienaar@${GATE}:5555	--to ${BERLIN}:22 --isRunning"
TARGETACTION[9]="tunnel.bash --reverse --sshArgs '-p 22022'	--from rudolphpienaar@${GATE}:5555	--to ${BERLIN}:22"
...
TARGET_CHECK[11]="tunnel.bash --reverse --sshArgs '-p 22022'	--from rudolphpienaar@${GATE}:4212	--to ${PARIS}:22 --isRunning"
TARGETACTION[11]="tunnel.bash --reverse --sshArgs '-p 22022'	--from rudolphpienaar@${GATE}:4212	--to ${PARIS}:22"
...
TARGET_CHECK[13]="tunnel.bash --reverse --sshArgs '-p 22022'	--from rudolphpienaar@${GATE}:4216 	--to ${GLACIER}:22 --isRunning"
TARGETACTION[13]="tunnel.bash --reverse --sshArgs '-p 22022'	--from rudolphpienaar@${GATE}:4216 	--to ${GLACIER}:22"
