...
TARGET_CHECK[51]="tunnel.bash --reverse --sshArgs '-p 22022'	--from rudolphpienaar@${GATE}:8000 --to ${CUBENEXT}:80 --isRunning"
TARGETACTION[51]="tunnel.bash --reverse --sshArgs '-p 22022'	--from rudolphpienaar@${GATE}:8000 --to ${CUBENEXT}:80" 
