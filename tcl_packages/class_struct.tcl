# class_struct.tcl
#
# This package provides general "pseudo class" construction/manipulation 
# routines as well as some general purpose functions.
#
...
# lst_ordered	returned	ordered list of values
#
    upvar $classIn arr
...
# initdata		in	structure based initialisation data (array values)
# filename	in (opt)	file containing initialisation data
# arr		returned	initialised class variable 
...
#
# If a data element is prefixed with `ptr' it is assumed to a "pointer" operation
# i.e. it denotes the name of a variable containing the actual data.
#
# class		in/out	name of array to be associated
# lst_key		in	list of array indices
# lst_data		in	list of corresponding values
# arr		returned	associated array
#
    upvar $class arr
	...
	if {![string first arr $value]} {
	    ...
	    set stripped [string trimleft $value ptr_]
...
#
# class		out	class variable to be dumped
