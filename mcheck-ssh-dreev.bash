...
TARGET_CHECK[37]="tunnel.bash --forward	--from 7772 --via ch137123@${DREEV} --to localhost:7772 --isRunning"
TARGETACTION[37]="tunnel.bash --forward	--from 7772 --via ch137123@${DREEV} --to localhost:7772"
