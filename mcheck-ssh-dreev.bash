...
TARGET_CHECK[36]="tunnel.bash --reverse	--from ch137123@${DREEV}:3142 --to ${RCMAJESTY}:3142 --isRunning"
TARGETACTION[36]="tunnel.bash --reverse	--from ch137123@${DREEV}:3142 --to ${RCMAJESTY}:3142"
