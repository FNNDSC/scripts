...
G_SYNOPSIS="
 ...
 SYNOPSIS
	...
	fs_batch.bash        	-t <batchTableFile>                           \\
                                [-v <verbosity>]

 DESCRIPTION

	'fs_batch.bash' is a batch controller for a set of 'fs_meta.bash'
 ...
 BATCH TABLE
        ...
        columns:
              ...
              <DICOMDIR>;<dcmSeriesFile>;<DIRsuffix>

        where <DICOMDIR> is the directory within DEFAULTDIR to process,
        <dcmSeriesFile> is a file in the series to process.
...
REQUIREDFILES="common.bash fs_meta.bash"
...
for LINE in $TABLE ; do
  ...
  DIRSUFFIX=$(echo $LINE | awk -F \; '{print $3}')
